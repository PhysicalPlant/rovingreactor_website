        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <ol className="list-decimal list-inside text-white text-xl mb-6">
              <li><span className="text-[#8be8d7]">Your Stake in the Atom</span><br />A geodesic-dome exhibit transported by truck to fairs, shopping centers, and other public venues. Inside the dome, visitors could operate robotic "hot-lab" arms to simulate the safe handling of radioactive materials and watch live demos of nuclear science in action. During a single regional tour, <span className="text-[#8be8d7]">tens of thousands</span> of people would often visit within just a few months. <a href="#your-stake-in-the-atom">[1]</a><br />          <img src="/img/ThisAtomicWorld-cropped.png" alt="This Atomic World" className="w-full h-auto my-6" />
              </li>
              <li className="my-6"><span className="text-[#8be8d7]">This Atomic World</span><br />A high-school lecture and demonstration tour that eventually deployed up to <span className="text-[#8be8d7]">23 specially equipped vans</span> across the country. Each mobile unit carried live demonstration gear (reactor models, Geiger counters, cloud chambers) to engage students with hands-on science. At the program's peak in the early-to-mid 1960s, it visited thousands of schools, reaching <span className="text-[#8be8d7]">over a million students per year</span> <a href="#this-atomic-world">[2]</a><br />

              </li>
              <li><span className="text-[#8be8d7]">Atoms for Peace</span><br />An umbrella initiative that included traveling trailer exhibits in the U.S. and large-scale international showcases abroad. One such American trailer traveled to libraries and local fairs, featuring scaled models of reactors, interactive panels, and displays of atomic agriculture. Collectively, the AEC's Atoms for Peace projects reached <span className="text-[#8be8d7]">hundreds of thousands — ultimately millions</span> — of curious visitors who learned about nuclear energy's peaceful potential. <a href="#atoms-for-peace">[3]</a><br />
                <img src="/img/atoms-for-peace-van.jpg" alt="Atoms for Peace" className="w-full h-auto my-6" />
              </li>
            </ol>
            <div className="border-t border-white pt-6">
              <p className="text-white text-xl mb-6"><span className="text-[#8be8d7]">Atomsville, U.S.A.</span> at the 1964-65 New York World's Fair<br /> Building on that momentum, the AEC unveiled <span className="text-[#8be8d7]">Atomsville, U.S.A.</span> at the 1964–65 New York World's Fair—an event that attracted more than <span className="text-[#8be8d7]">51 million visitors</span> overall <a href="#atomsville">[4]</a>. Atomsville took the form of a playful, futuristic town powered by nuclear energy. Children compared their pedal power to the punch of uranium and explored futuristic kitchens and farms designed to spark curiosity rather than fear. Period press coverage noted heavy foot traffic, suggesting that the pavilion likely saw <span className="text-[#8be8d7]">hundreds of thousands, if not millions</span> of families during the Fair's two-year run.</p >
            </div>
            <div className="border-t border-white pt-6">
