          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-0">
            ...
            <div className="max-w-2xl">
              <div className="mb-4 md:mb-6">
                ...
                <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl text-white mb-4 ![line-height:2rem] md:![line-height:3rem]">Roving Reactor Exhibits</h1>

                <Image className="mb-5 w-full h-auto my-3 " src="/img/2025-img/RR_B_color_1200.jpg" alt="Roving Reactor Exhibits Illustration A" width={1000} height={1000} />
                ...
                <Box sx={{ paddingRight: 2, paddingTop: 0, paddingBottom: 2 }} className="mt-8 mb-8">
                  ...
                  <Image className="mb-5 w-full h-auto my-3 rounded-lg " src="/img/2025-img/RR_B_bw_1200.jpg" alt="Roving Reactor Exhibits Illustration B" width={1000} height={1000} />
                  <Image className="mb-5 w-full h-auto my-3 rounded-lg" src="/img/2025-img/RR_A_bw_1200.jpg" alt="Roving Reactor Exhibits Illustration C" width={1000} height={1000} />
                  <Image className="mb-5 w-full h-auto my-3 rounded-lg" src="/img/2025-img/RR_C_bw_1200.jpg" alt="Roving Reactor Exhibits Illustration D" width={1000} height={1000} />
                </Box>
