  ...
  return (
    <ThemeProvider theme={theme}>
      <h1 className="text-5xl text-orange-900 mb-3 font-normal">
        National Nuclear Soup Night
      </h1>
      <h3 className="text-3xl text-orange-900 mb-3 font-normal italic">
            ...
            <div className="text-orange-950">
              <p className="text-xl mb-4">
                ...
                <a
                  ...
                  className="text-orange-700 hover:text-orange-900 no-underline hover:underline"
                >
                  Generation Atomic
                </a>
                ,{" "}
                <a
                  href="https://www.mothersfornuclear.org/"
                  rel="noopener noreferrer"
                  className="text-orange-700 hover:text-orange-900 no-underline hover:underline"
                >
                  Mothers for Nuclear
                ...
                , and the{" "}
                <a
                  href="https://www.rovingreactor.org/"
                  rel="noopener noreferrer"
                  className="text-orange-700 hover:text-orange-900 no-underline hover:underline"
                >
                  Roving Reactor Project
                </a>{" "}
                want to fill 4 dining rooms across America with thoughtful
                people from the nuclear energy ecosystem for an evening of hot
                soup and conversation about where nuclear energy is headed and
          ...
          >
            <div className="text-orange-950">
              <ul className="text-xl list-disc list-outside ml-6">
                ...
                <li>
                  Six to eight attendees per gathering, from across nuclear
                  energy disciplines
                </li>
          ...
          >
            <div className="text-orange-950">
              ...
              <ul className="text-xl list-disc list-outside ml-6">
                ...
                <li>
                  An open forum for conversation with a range of nuclear energy
                  perspectives
                </li>
      ...
      <div className="text-xl text-orange-950 mb-3 font-normal">
        <p className="mb-4">
          Whether you're in{" "}
          <strong>
            research, regulation, industry, investment, advocacy, education
          </strong>{" "}
          - or whether you're a <strong>student!</strong> - we want to bring
          nuclear's many voices to the table.
        </p>
        <p className="mb-4">
      ...
      <div className="border border-orange-800 rounded-lg p-4 md:p-6 mt-12">
        <h3 className="text-xl text-orange-800 mb-4 md:mb-6 font-normal">
          Brought to you by...
        </h3>
        <div className="flex flex-row items-center justify-center gap-1 md:gap-4 mx-auto px-2 md:px-0">
          <InfoPopover
            content={
              <div>
                <p>
                  Generation Atomic inspires and mobilizes advocates to build a
                  cultural movement supporting a clean future powered by nuclear
                  energy.
                </p>
              </div>
            }
          ...
          <InfoPopover
            content={
              <div>
                <p>
                  Mothers for Nuclear champions nuclear energy as a vital
                  solution to climate change, air pollution, and energy poverty,
                  driven by moms protecting their children's future.
                </p>
              </div>
            }
            linkText="Visit Website"
          ...
          <InfoPopover
            content={
              <div>
                <p>
                  The Roving Reactor Project is a traveling exhibit designed to
                  educate and encourage action on nuclear energy.
                </p>
              </div>
            }
            linkText="Visit Website"
